    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <TouchableOpacity style={[styles.card, Shadow.card]} onPress={() => setSelectedRental(item)} activeOpacity={0.88}>
              ...
              <View style={styles.bottomRow}>
                ...
                {isPendingRental(item) ? (
                  ...
                  <Button title="Theo dõi" variant="secondary" onPress={() => setSelectedRental(item)} style={styles.followButton} />
                )}
              </View>
            </TouchableOpacity>
          );
